...
const Navbar = () => {
    ...
    function changeColor(){
        menuRef.current.style.backgroundColor="#D3FD50"
  ...
  return (
  <div className='flex fixed justify-between w-full  z-4'>
      <div className='m-[0.6vw] relative'>
 <div>
...
<div ref={menuRef} onClick={()=>setNavOpen(true)} onMouseEnter={changeColor} onMouseLeave={ResetColor} className='cursor-pointer transition-all duration-300 ease-in-out w-[15vw] h-[3.5vw] bg-black flex flex-col pt-[1vw] gap-[0.5vw] items-end'>
    <div className='w-[8vw] h-[0.1vw] bg-white'></div>
    <div className='w-[6vw] h-[0.1vw] bg-white'></div>
